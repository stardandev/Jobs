              ...
              <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div className="panel panel-default">
                  ...
                  <div id="collapseFive" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                    <div className="panel-body">
                      Legably is free for attorneys to create profiles, search for work, and post jobs to be completed. Legably only takes a small percentage fee of the total budgeted work being performed. This only happens once both attorneys have agreed to the total budget and the hiring attorney has been billed for the work.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">
                  ...
                  <div id="collapseSix" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                    <div className="panel-body">
                      Service charges are calculated as a percentage of the total project budget, as set by the job poster. Service charges generally amount to 15% of the total project budget. These charges cover Stripe transaction fees.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">
                ...
                <div className="panel panel-default">
                  ...
                  <div id="collapseEleven" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEleven">
                    <div className="panel-body">
                      Your Stripe Connect account preferences can be changed by clicking the Access Stripe Dashboard button on the job Start Pending screen. If you have any issues with changing your account preferences please contact the Legably support team at <a className="contact-link" href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a>.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">
                  ...
                  <div id="collapseTweleve" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwelve">
                    <div className="panel-body">
                      We strongly urge hiring managers and candidates to try and work out job problems using the Send Message feature of the Legably platform. However, in the event that either party feels they cannot get satisfaction please contact the Legably support team at <a className="contact-link" href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a> and we will put you in contact with the Stripe Connect dispute management group which has a processes in place for negotiation and arbitration.
                      <br /><br />
                      In the near future we are working to directly integrate the Stripe Connect negotiation and arbitration process directly into the Legably platform.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">
